...
$data modify storage player_statues:data macro.id set from storage player_statues:data statues[$(statue_index)].elements[$(element_index)].id
...
$data modify storage player_statues:data macro.right_rotation set from storage player_statues:data statues[$(statue_index)].elements[$(element_index)].right_rotation
$data modify storage player_statues:data macro.scale set from storage player_statues:data statues[$(statue_index)].elements[$(element_index)].scale
$data modify storage player_statues:data macro.left_rotation set from storage player_statues:data statues[$(statue_index)].elements[$(element_index)].left_rotation
$data modify storage player_statues:data macro.translation set from storage player_statues:data statues[$(statue_index)].elements[$(element_index)].translation

$data modify storage player_statues:data macro.width set from storage player_statues:data statues[$(statue_index)].elements[$(element_index)].width
$data modify storage player_statues:data macro.height set from storage player_statues:data statues[$(statue_index)].elements[$(element_index)].height
$data modify storage player_statues:data macro.response set from storage player_statues:data statues[$(statue_index)].elements[$(element_index)].response
